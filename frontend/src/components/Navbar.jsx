...
export default function Navbar() {
  ...
  const isUserArea = ['/dashboard', '/account', '/matches', '/compatibility-requests', '/saved-candidates', '/complete-application'].some((path) => pathname.startsWith(path))
  return (
    <header className="border-b border-teal-100 bg-linen/80 backdrop-blur">
      <div className="max-w-5xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        {!isUserArea && <nav className="flex items-center gap-4 text-sm font-medium">
